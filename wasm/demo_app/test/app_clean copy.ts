...
async function main(sceneActionFilename: string | undefined, actionsApiPath: string = "api/scenes/actions", canvasContainer: HTMLDivElement, recordingMode: boolean = false) {
  try {
    ...
    app = new MujocoApp(mujoco, 'mujoco-canvas', 'top-down', canvasContainer, recordingMode); //"3rd-person");
...
function main2() {
  ...
  // main("ithor_1_actions.json",
    "/actions", document.getElementById(containerId), false)
        .catch((error) => {
